/*
 * MyJailShop - Store by redwerewolf Support Plugin.
 * by: shanapu
...
public Plugin myinfo = 
{
	...
	author = "shanapu",
	description = "Add Support for Credits from SM Store",
	version = "1.0",
...
public int MyJailShop_OnGetCredits(int client)
{
	...
	int credits = Store_GetCreditsEx(accountId);
...
public void MyJailShop_OnSetCredits(int client, int credits)
{
	...
	Store_GiveCredits(accountId, (oldCredits-credits));
}